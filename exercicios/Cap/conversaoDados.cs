...
namespace livrocsharp
{
    class conversaoDados
    {
        ...
        {         
            // boxing
            int percentual1 = 10;
            object objeto1 = percentual1;
            //unboxing 
            object objeto2 = 10;
            int desconto2 = (int)objeto2;
            ...
            WriteLine($"objDesconto: {objDesconto} - {desconto.GetType()}");
            ...
            try 
            {
                ...
                // retorna -150, os parênteses representam o valor negativo para
                ...
                WriteLine($"Simbolo da moeda: {NumberFormatInfo.CurrentInfo.CurrencySymbol}");
                ...
                // retorna 5432123456
                WriteLine($"{Int64.Parse("54321123456")}");
            ...
            try
            {
            // Conversões com Convert.ToString
